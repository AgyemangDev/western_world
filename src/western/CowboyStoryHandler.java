...
System.out.println("\n🎯 CHOICE 2:");
System.out.println("   (1) Accept her plea and promise to help (+Reputation)");
System.out.println("   (2) Refuse politely - 'Ain't my business, ma'am' (-Reputation)\n");

int choice = getValidatedNumericChoice(2);  // ✅ Enforces only 1 or 2 allowed
...
switch (choice) {
    ...
    /**
 * Reads and validates a numeric player choice (1, 2, or 3).
